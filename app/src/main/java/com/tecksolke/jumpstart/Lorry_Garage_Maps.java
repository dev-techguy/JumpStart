...
public class Lorry_Garage_Maps extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_garage__maps);
...
//                        toSpeech.speak("Hello " + getUsername() + "." + garage, TextToSpeech.QUEUE_FLUSH, null);
    ...
    public boolean onSupportNavigateUp() {
        onBackPressed();
        toSpeech.stop();
        startActivity(new Intent(Lorry_Garage_Maps.this, Lorry_JumpStart.class));
        finish();
        return true;
    }
