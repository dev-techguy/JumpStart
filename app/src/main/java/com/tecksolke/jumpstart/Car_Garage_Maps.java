...
public class Car_Garage_Maps extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car__garage__maps);
    ...
    public boolean onSupportNavigateUp() {
        onBackPressed();
        toSpeech.stop();
        startActivity(new Intent(Car_Garage_Maps.this, Car_JumpStart.class));
        finish();
        return true;
    }
