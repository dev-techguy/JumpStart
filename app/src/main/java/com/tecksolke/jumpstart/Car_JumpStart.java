...
public class Car_JumpStart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * */
        ViewPager viewPager = findViewById(R.id.car_pager);
        ViewPagerAdapter adapterLayout = new ViewPagerAdapter(getSupportFragmentManager());

        // Add Fragments to adapter one by one
        adapterLayout.addFragment(new Car_Spinner_Faults(), "Samples");
        adapterLayout.addFragment(new Car_User_Faults(), "Faults");
        viewPager.setAdapter(adapterLayout);

        TabLayout tabLayout = findViewById(R.id.car_tabs);
...
//                    toSpeech.speak("Hello " + getUsername() + ",  Am JumpStart , How May I Help You Fix Your Car", TextToSpeech.QUEUE_FLUSH, null);
                    toSpeech.speak(env.voice + " Car", TextToSpeech.QUEUE_FLUSH, null);
                } else {
                    niftyDialogBuilder
